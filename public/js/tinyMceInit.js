...
jQuery(document).ready(function () {
  jQuery('.fluentform-post-content').each(function (index, el) {
    var $el = jQuery(el);
        ...
        tinymce: {
          ...
          setup: function setup(ed) {
            ed.on('change', function (ed, l) {
              var content = wp.editor.getContent(editorId);
...
/***/ 0:
/*!********************************************!*\
  !*** multi ./src/assets/js/tinyMceInit.js ***!
  \********************************************/
/*! no static exports found */
