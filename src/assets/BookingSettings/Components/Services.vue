            ...
            <el-row class="setting_header">
                ...
                <el-col :md="10">
                    <div class="pull-right">
                            <el-button @click="showAddItem()"  size="medium"  type="primary" >Add New (old format)</el-button>
                    </div>
                    <el-button type="primary" size="medium">
                        <router-link tag="span" to="/service" type="primary" >{{ $t('Add New Service (new format)') }} </router-link>
                    </el-button>
                ...
                <el-table-column width="220" label="Actions">
                    <template slot-scope="scope">
                        ...
                        <el-button type="info" size="mini" icon="el-icon-edit">
                            <router-link tag="span" :to="`/service/?service_id=${scope.row.id}`" type="primary" >{{ $t('Edit (new)') }} </router-link>
                        </el-button>
