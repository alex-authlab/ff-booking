...
<!--            <el-button @click="deleteItem(scope.row)" type="danger" size="mini" icon="el-icon-delete"></el-button>-->
          </template>
        </el-table-column>
      </el-table>
            ...
            <el-col :span="12">
              <el-form-item label="Booking Type">
                ...
                <el-select placeholer="Select Type"  v-model="editing_item.booking_type">
                  <el-option v-for="(type,value) in booking_types" :key="value" :label="type" :value="value"></el-option>
                </el-select>
          ...
          <el-row :gutter="30">
            <el-col :span="8">
              <el-form-item label="Slot Capacity">
                <el-input-number v-model="editing_item.slot_capacity" :min="1" :max="20"></el-input-number>
                <p>Single Slot Capacity </p>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="Max Booking">
                <el-input-number v-model="editing_item.max_bookings" :min="1" :max="20"></el-input-number>
                <p>Maximum bookings in a day</p>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="Calculation Value">
                <el-input-number v-model="editing_item.calc_value" :min="0" :max="999"></el-input-number>
