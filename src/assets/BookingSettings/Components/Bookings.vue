                  ...
                  <el-table
                    ...
                    >
                      <template slot-scope="props">
                        <a v-if="props.row.submission_url" :href="props.row.submission_url">#{{props.row.entry_id}}</a>
                      </template>
                    </el-table-column>
                    <el-table-column
                        prop="human_date"
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="props">
                        <div>
                          <el-tag class="ff-booking-stat " v-if="props.row.booking_status =='booked'" type="success">{{ props.row.booking_status }}</el-tag>
                          <el-tag class="ff-booking-stat " v-else-if="props.row.booking_status =='pending'" type="warning">{{ props.row.booking_status }}</el-tag>
                          <el-tag class="ff-booking-stat " v-else type="info" >{{ props.row.booking_status }}</el-tag>
                        </div>
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column
                        ...
                        width="200">
                      <template slot-scope="props">
                        <el-select size="small" @change="changeStatus(props.row.id,props.row.booking_status)" v-model="props.row.booking_status" placeholder="Select">
                          <el-option
                    ...
                    >
                      <template slot-scope="props">
                        <el-button @click="showDetails(props.row.id)" type="primary" icon="el-icon-view" size="mini"></el-button>
                      </template>
