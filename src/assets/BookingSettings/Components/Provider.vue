          ...
          <el-row :gutter="30">
            <el-col :span="12">
              <el-form-item label="Assigned User">
                <el-select placeholer="Select User" style="width: 100%;" v-model="editing_item.assigned_user">
                  <el-option v-for="(user,userId) in users" :key="userId" :label="user" :value="userId"></el-option>
                </el-select>
            ...
            <el-col :span="12">
              <el-form-item label="Assigned Services">
                <el-select placeholer="Select Service" style="width: 100%;" multiple
                  ...
                  <el-option v-for="(serviceName, serviceId) in services" :key="serviceId" :label="serviceName"
