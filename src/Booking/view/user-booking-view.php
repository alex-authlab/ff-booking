...
<head>
    ...
    <title><?php esc_html_e('FF Simple Booking', FF_BOOKING_SLUG) ?></title>
    <?php
    wp_head();
    ?>
    <style type="text/css">
        ...
        .ffb_bttns:active, .ffb_bttns:focus{
            color: #ffffff;
        ...
        .ff_booking_info.slot{
            min-width: 320px;
        }
        .ff_booking_info.with-border{
            border-right: 1px solid #efefef;
            min-width: 355px;
        }
        #ff_booking_view > div.ff_booking_body > div > div > div:nth-child(2)
        .ff_bk_info_list {
            list-style: none;
            text-align: left;
            font-weight: 500;
        ...
        .ff_bk_info_list.ff-time-slot-container {
            overflow-y: auto;
            max-height: 350px;
            max-width: 300px;
        }

        .ff_bk_info_list.ff-time-slot-container li{
            margin: 0px 10px;
            margin: 20px 10px;
            justify-content: center;
            padding: 5px 10px;
        ...
        .ff_booking_footer{
          display: block;
            ...
            font-style: italic;
            color: #282828;}
         .ff_booking_title, .ff_booking_footer{
             font-size: 10px;
         }
         #ffb_view_picker{
             display: none;
        ...
        .ffb_form .ff-el-group.ff_list_buttons .ff-el-form-check {
        ...
        .ffb_form .ff-el-group.ff_list_buttons .ff-el-form-check label {
            margin: 0;
        }
        .ffb_form .ff-el-group.ff_list_buttons .ff-el-form-check label > span {
            line-height: 1;
            font-weight: 500;
            white-space: nowrap;
        ...
        .ffb_form ff-el-group.ff_list_buttons .ff-el-form-check.ff_item_selected label > span {
            color: #fff;
            background-color: #409eff;
            border-color: #409eff;
            box-shadow: -1px 0 0 0 #8cc5ff;
        }
        .ffb_form .ff-el-group.ff_list_buttons .ff-el-form-check input {
            opacity: 0;
            outline: none;
            position: absolute;
            margin: 0;
...
<div id="ff_booking_view">
    <div class="ff_booking_header">
        <div class="ff_booking_title">
            Booking Information
        </div>

    </div>
    <div class="ff_booking_body">
            ...
            <div class="ff_booking_view_holder">
                <div class="ff_booking_content">
                    <div class="ff_booking_info with-border">
                        <h1>Booking : <span><?php echo ucfirst($booking_status) ?>  </span></h1>
                        <p>Appointment for <b><?php echo ucfirst($service) ?> </b> by  <b><?php echo ucfirst($provider) ?></b></p>
                        <?php if($description != '') {
                            echo "<p>{$description}</p>";
                        }?>

                        <div class="ff_booking_bttns">
                            <?php if($allowUserReschedule && $booking_status != 'canceled'){ ?>

                                <a class="ffb_bttns resched-bttn" href="#">Reschedule</a>

                            <?php } if($allowUserCancel && $booking_status != 'canceled'){ ?>
                ...
                <?php if($allowUserReschedule){ ?>
                <div class="ff_booking_content ffb_form">
                    <div class="ff_booking_info ">

                        <input type="text" class="ffb_input" id="ffb_view_picker">
                        <br>
                        <button class="ffb_bttns ffb-submit-bttn" >Submit</button>
    ...
    <div class="ff_booking_footer">
        Powered by Simple Booking
    </div>
</div>
